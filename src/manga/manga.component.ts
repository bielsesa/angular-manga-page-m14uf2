...
export class MangaComponent implements OnInit, OnDestroy {
  @ViewChild(PreviewDirective, { static: true })
  previewContainer: PreviewDirective;
  ...
  constructor(private componentFactoryResolver: ComponentFactoryResolver) {
    this.llistaMangas = [
      new Manga(
        "Attack on titans",
        "../assets/images/attackontitans.jpg",
        Genere.Action,
        new Autor("Hajime", "Isayama", new Date(2009, 9, 9), "Japó")
      ),
      new Manga(
        "Eureka seven",
        "../assets/images/eurekaseven.jpg",
        Genere.Sci_fi,
        new Autor("Jinsei", "Kataoka", new Date(2005, 4, 17), "Japó")
      ),
      new Manga(
        "The promised neverland",
        "../assets/images/thepromisedneverland.jpg",
        Genere.Adventure,
        new Autor("Kaiu", "Shirai", new Date(2019, 10, 1), "Japó")
      ),
      new Manga(
        "Blue exorcist",
        "../assets/images/blueexorcist.jpg",
        Genere.Fantasy,
        new Autor("Kazue", "Kato", new Date(2009, 4, 4), "Japó")
      ),
      new Manga(
        "Evangelion",
        "../assets/images/evangelion.jpg",
        Genere.Sci_fi,
        new Autor("Hideaki", "Anno", new Date(1995, 10, 4), "Japó")
      ),
      new Manga(
        "Tokyo Ghoul",
        "../assets/images/tokyoghoul.jpg",
        Genere.Horror,
        new Autor("Sui", "Ishida", new Date(2011, 9, 18), "Japó")
      ),
      new Manga(
        "Boku no hero",
        "../assets/images/bokunohero.jpg",
        Genere.Action,
        new Autor("Kohei", "Horikoshi", new Date(2014, 7, 7), "Japó")
      ),
      new Manga(
        "Sword art online",
        "../assets/images/sao.jpg",
        Genere.Sci_fi,
        new Autor("Sui", "Ishida", new Date(2013, 12, 31), "Japó")
      ),
      new Manga(
        "Berserk",
        "../assets/images/berserk.jpg",
        Genere.Magic,
        new Autor("Kentaro", "Miuda", new Date(1997, 10, 7), "Japó")
      ),
      new Manga(
        "Detective Conan",
        "../assets/images/conan.jpg",
        Genere.Action,
        new Autor("Gosho", "Aoyama", new Date(1994, 1, 19), "Japó")
      ),
      new Manga(
        "One punch man",
        "../assets/images/opm.jpg",
        Genere.Action,
        new Autor("One", "-", new Date(2009, 7, 3), "Japó")
      ),
      new Manga(
        "Dragon Ball",
        "../assets/images/db.jpeg",
        Genere.Action,
        new Autor("Akira", "Toruyama", new Date(1984, 11, 20), "Japó")
      )
    ];

    this.llistaMangasJSObject = [
      {
        titol: "Attack on titans",
        imgUrl: "../assets/images/attackontitans.jpg",
        genere: Genere.Action,
        autor_nom: "Hajime",
        autor_cognom: "Isayama",
        data: new Date(2009, 9, 9),
        autor_pais: "Japó"
      },
      {
        titol: "Eureka seven",
        imgUrl: "../assets/images/eurekaseven.jpg",
        genere: Genere.Sci_fi,
        autor_nom: "Jinsei",
        autor_cognom: "Kataoka",
        data: new Date(2005, 4, 17),
        autor_pais: "Japó"
      },
      {
        titol: "The promised neverland",
        imgUrl: "../assets/images/thepromisedneverland.jpg",
        genere: Genere.Adventure,
        autor_nom: "Kaiu",
        autor_cognom: "Shirai",
        data: new Date(2019, 10, 1),
        autor_pais: "Japó"
      },
      {
        titol: "Blue exorcist",
        imgUrl: "../assets/images/blueexorcist.jpg",
        genere: Genere.Fantasy,
        autor_nom: "	Kazue",
        autor_cognom: "Kato",
        data: new Date(2009, 4, 4),
        autor_pais: "Japó"
      }
    ];
    ...
    this.animes = [
      {
        titol: "Anohana",
        genre: "Coming-of-age",
        creator: "Super Peace Busters",
        imgUrl: "../assets/images/anohana.jpg",
        description:
      ...
      {
        titol: "Shingeki no kyojin",
        genre: "Action",
        creator: "Hajime Isayama",
        imgUrl: "../assets/images/shingeki.jpg",
        description:
      ...
      {
        titol: "Your lie in April",
        genre: ["Romantic", "Drama"],
        creator: "Naoshi Arakawa",
        imgUrl: "../assets/images/yourlie.jpg",
        description:
  ...
  filtrar() {
    var contenido: HTMLHeadingElement = <HTMLHeadingElement>(
      document.getElementById("contingut")
    );
    contenido.style.visibility = "hidden";
    var resultado: HTMLHeadingElement = <HTMLHeadingElement>(
      document.getElementById("resultado")
    );
    var tipoSelect: HTMLInputElement = <HTMLInputElement>(
      document.getElementById("tipoSelect")
    );
    var text = tipoSelect.value; //valor del tipo de select
    //alert(text);
    resultado.innerHTML = "";
    var formulario: HTMLInputElement = <HTMLInputElement>(
    ...
    this.llistaMangas.forEach(function(value) {
      ...
      if (text == "genere") {
        ...
        if (nombre.indexOf(texto) > -1 && texto != "") {
          resultado.innerHTML += `
          <td>
              <h3>${Manga.genereToString(value.genere)}</h3> <img src="${
            value.imgUrl
          }" width="330px" heigth="550px"> 
          </td>
          `;
        }
      }
  ...
  mostraPreview(event, nomManga) {
    ...
    switch (nomManga) {
      case "Attack on titans":
        (<PreviewComponent>componentRef.instance).baseImgName =
          "../assets/images/preview/aot";
        break;

      case "Berserk":
        (<PreviewComponent>componentRef.instance).baseImgName =
          "../assets/images/preview/berserk";
        break;

      case "Blue exorcist":
        (<PreviewComponent>componentRef.instance).baseImgName =
          "../assets/images/preview/be";
        break;

      case "Boku no hero":
        (<PreviewComponent>componentRef.instance).baseImgName =
          "../assets/images/preview/bnh";
        break;

      case "Detective Conan":
        (<PreviewComponent>componentRef.instance).baseImgName =
          "../assets/images/preview/dc";
        break;

      case "Dragon Ball":
        (<PreviewComponent>componentRef.instance).baseImgName =
          "../assets/images/preview/db";
        break;

      case "Eureka Seven":
        (<PreviewComponent>componentRef.instance).baseImgName =
          "../assets/images/preview/es";
        break;

      case "Evangelion":
        (<PreviewComponent>componentRef.instance).baseImgName =
          "../assets/images/preview/evgl";
        break;

      case "One punch man":
        (<PreviewComponent>componentRef.instance).baseImgName =
          "../assets/images/preview/opm";
        break;

      case "Sword art online":
        (<PreviewComponent>componentRef.instance).baseImgName =
          "../assets/images/preview/sao";
        break;

      case "The promised neverland":
        (<PreviewComponent>componentRef.instance).baseImgName =
          "../assets/images/preview/tpn";
        break;

      case "Tokyo Ghoul":
        (<PreviewComponent>componentRef.instance).baseImgName =
          "../assets/images/preview/tg";
        break;
    }
  }
}
